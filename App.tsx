        ...
        <div className="flex flex-col">
            <div className="flex items-center gap-1.5 mb-1">
                <span className="inline-flex items-center bg-zen-primary text-white text-[9px] font-black px-2 py-0.5 rounded shadow-zen-sm tracking-[0.1em] uppercase">
                    <i className="fa-solid fa-bolt-lightning text-[8px] mr-1.5 opacity-90"></i>
                    LV.11
                </span>
            </div>
            <h1 className="text-xl font-bold text-zen-text leading-tight tracking-tight">
                被召喚的勇者與金色奧捷
            </h1>
        </div>
        <div>
      ...
      {activeTab === 'search' && (
        <div className="absolute bottom-24 inset-x-0 z-[60] flex justify-center px-8">
            <div className="w-full max-w-sm animate-fade-in-up">
                <div className="bg-white/80 backdrop-blur-xl border border-stone-200/50 rounded-full shadow-lg p-1 flex items-center gap-2 group">
                    <div className="w-8 h-8 rounded-full bg-zen-primary/10 flex items-center justify-center text-zen-primary flex-shrink-0">
                    ...
                    <input 
                        ...
                        className="flex-1 bg-transparent border-none outline-none text-xs font-bold text-stone-600 placeholder:text-stone-300"
                    />
                    {searchTerm && (
                        <button 
